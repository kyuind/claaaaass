<template>
  <div class="text-center">
    <button v-if="!user.email" @click="kakaoLogin" class="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded">
      카카오 로그인
    </button>
    <div v-else>
      <p>닉네임: {{ user.name }}</p>
  ...
  export default {
    ...
    created() {
      ...
      if (!window.Kakao.isInitialized()) {
        window.Kakao.init("1e5635d84c3cf050ae691d57c6ea7420"); // 카카오 JavaScript 키
      }
