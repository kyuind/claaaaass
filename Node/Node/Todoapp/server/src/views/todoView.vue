...
<div id='app' class='container mt-5'>
    ...
    <div>
        ...
        <table class="table">
            <thead>
                <tr>
                    <th csope='col'>ID</th>
                    <th csope='col'>Title</th>
                    <th csope='col'>Status</th>
                    <th csope='col'>Delete</th>
                    <th csope='col'>Re-title</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="todo in todos" :key='todo.id'>
                    ...
                    <td class="align-middle"><button class="btn btn-danger btn-sm" @click="deleteTodo(todo.id)">삭제</button></td>
                    <td class="align-middle"><button class="btn btn-primary btn-sm" @click="openModal(todo.id)" >수정</button></td>
                </tr>
            </tbody>
        </table>
        <form @submit.prevent="">
    ...
    <div v-if="isModalVisible" class="modal d-block" tabindex="-1"> <!--modal d-block 모달창 보이기-->
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">입력해주세요.</h5>
            </div>
            <div class="modal-body">
            Title Name <input type="text" v-model="editTitle">
            
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" @click="updateTitle">변경하기</button>
