    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='slmple one=line txet', max_length=100, verbose_name='DESCRIPTION')),
                ('image', models.ImageField(blank=True, null=True, upload_to='blog/%y/%m/', verbose_name='IMAGE')),
                ('content', models.TextField(verbose_name='CONTENT')),
                ('create_date', models.DateField(auto_now_add=True, verbose_name='CREATE DT')),
                ('update_date', models.DateField(auto_now=True, verbose_name='UPDATE DT')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateTimeField(auto_now=True, verbose_name='UPDATE DT')),
